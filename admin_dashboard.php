...
$counts['jobseekers'] = $conn->query("SELECT COUNT(*) FROM lmis3_jobseekers_table")->fetch_row()[0];
$counts['jobs'] = $conn->query("SELECT COUNT(*) FROM lmis3_jobs")->fetch_row()[0];
...
<head>
  ...
  <style>
    body.dark-mode { background-color: #212529; color: white; }
    body.dark-mode .card { background-color: #343a40; color: white; }
    body.dark-mode .navbar, body.dark-mode .footer { background-color: #1c1e21; }
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
  <div class="container">
    ...
    <a class="navbar-brand" href="admin_applications_advanced.php">Job Applications</a>
    <a class="navbar-brand" href="manage_roles.php">Manage-Roles</a>
    
    <ul class="navbar-nav ms-auto">
      <li class="nav-item"><a class="nav-link" href="main_dashboard.php">Main Dashboard</a></li>
      <li class="nav-item"><a class="nav-link theme-toggle" onclick="toggleTheme()">🌓</a></li>
  ...
  <div class="row mt-5">
    <div class="col-md-6">
      <div class="d-flex justify-content-between align-items-center">
        <h5>Recent Users</h5>
        <a href="export_users.php?format=csv" class="btn btn-sm btn-outline-success">Export CSV</a>
      </div>
      ...
      <a href="manage_users.php" class="btn btn-primary btn-sm mt-2">Manage Users</a>
    </div>
...
<footer class="bg-light text-center py-3 mt-5">
  <div class="container">
    <small>© <?= date('Y') ?> JMIS System | Admin Panel</small>
  </div>
</footer>
